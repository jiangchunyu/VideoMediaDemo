...
//    ad.php/admin/vodserver/getVodServerList
    ...
    public static final String REGISTER_URL = BASE_URL + "/api.php?action=register";
    public static final String LOGIN_URL = BASE_URL + "/api.php?action=login";
    public static final String RETURN_URL = BASE_URL + "/api.php?action=fankui";
    public static final String BASE_DATA_URL = BASE_URL + "/peizhijson.php";
    public static final String CARD_CODE_URL = BASE_URL + "/api.php?action=checkkami";
    public static final String REFRESH_TOKEN_URL = BASE_URL + "/api.php?action=getinfo";
